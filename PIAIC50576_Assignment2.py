...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.concatenate((np.repeat(arr,3),arr,arr), axis=0)#write your code here 
...
def function18():
    ...
    x = np.count_nonzero(students[students<100]) # Write you code Here
    return x
...
def function19():
    ...
    output = X*np.transpose(W)+b    # Write your code here
    return output
    #expected output
    """
